"""Standard train-and-evaluate runner for single-model NCM experiments.

This runner is the quality-oriented path:
- generate or reuse one dataset
- build one pipeline/model
...
class NCMRunner(BaseRunner):
    """Run a standard single-model experiment and report quality metrics."""
